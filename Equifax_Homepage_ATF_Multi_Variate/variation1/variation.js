    ...
    (function () {
      if(!document.querySelector('.eg-usp'))
      try {
        /* main variables */
        var debug = 0;
        var variation_name = "";
...
document.querySelector('.wave-layer').insertAdjacentElement('beforebegin',document.querySelector('.wave-layer-M'))
    }
    
        /* Initialize variation */
        waitForElement(".header-wrapper .wave-layer", init, 50, 15000);
      } catch (e) {
